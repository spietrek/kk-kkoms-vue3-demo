    ...
    <div class="tw-stats tw-shadow-2xl">
      <div class="tw-stat">
        <div class="tw-stat-title">
          {{
            $t(
              'features.hrbridge.organisms.kkhrbridgewrapper2.postsCreatedUsingComposition',
            )
          }}
        </div>
        ...
        <div class="tw-stat-desc">
          {{
            $t('features.hrbridge.organisms.kkhrbridgewrapper2.fromLastMonth', {
              '1': postsPercentageStatus,
            })
          }}
        </div>
      </div>
